...
CACHE = Path(__file__).resolve().parent.parent / "data" / ".regime_cache"
...
def build_wide():
    ...
    files = glob.glob(str(Path(__file__).resolve().parent.parent /
                          "data/kline_daily_enriched/**/*.parquet"), recursive=True)
