...
用法: python run_factor_semantic.py
"""
...
from factor_dsl import StackVM, formula_to_str
from run_factor_search import build_features, cross_sectional_score
from run_factor_oos import select_symbols, load_subset, eval_formulas, norm_cdf

HERE = Path(__file__).resolve().parent
OUT = HERE.parent / "strategy_factor_semantic.json"
...
def main():
    ...
    for d in results:
        flag = "✓显著" if d["significant_oos"] else "✗不显著"
...
def _gen_rand(rng):
    ...
    from factor_dsl import gen_formula
