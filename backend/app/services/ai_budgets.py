...
受控入口 (nl_screener / custom_signal_draft / strategy_profile_deep_review / trading_autopsy /
...
_BUDGETS: dict[str, EntryBudget] = {
    ...
    "custom_signal_draft": EntryBudget("custom_signal_draft", 0.0, 1800, 60.0),
    "strategy_profile_deep_review": EntryBudget("strategy_profile_deep_review", 0.2, 2000, 60.0),
    ...
    "stock_analysis": EntryBudget("stock_analysis", 0.5, 4500, 180.0, context_max_tokens=12000),
...
def resolve_budget(
    ...
    *,
    ...
    return EntryBudget(
        ...
        max_tokens=min(int(max_tokens), base.max_tokens)
