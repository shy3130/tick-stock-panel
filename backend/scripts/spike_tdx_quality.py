...
def main() -> None:
    ...
    for symbol in SYMBOLS:
        ...
        asset_type = "hk" if suffix == "HK" else None
        daily = client.get_wide(code, limit=1, asset_type=asset_type)
        ...
        rows.append({
            ...
            "minutes_rows_today": len(client.get_minutes(code, today, asset_type=asset_type)),
            "trans_rows_today": len(client.get_trans(code, today, asset_type=asset_type)),
        })
