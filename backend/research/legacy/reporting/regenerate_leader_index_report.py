"""旧 leader-index 实验的报告修复器；不属于当前报告入口。

从已落盘的 strategy_leader_regime.json + .regime_cache/leader_index.parquet 重建
Markdown 报告，不重跑回测。
"""
import json
...
OUT = REGIME_ARTIFACTS_DIR
JP = OUT / "strategy_leader_regime.json"
MP = OUT / "strategy_leader_regime_report.md"
LEADER = DATA_DIR / ".regime_cache" / "leader_index.parquet"
