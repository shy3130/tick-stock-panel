...
from factor_dsl import StackVM, gen_formula, formula_to_str, FEATURE_NAMES
from run_factor_search import build_features, cross_sectional_score, SEED_FORMULAS

HERE = Path(__file__).resolve().parent
OUT = HERE.parent / "strategy_factor_oos.json"
