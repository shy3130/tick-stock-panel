...
export const BUILTIN_NAV: NavItem[] = [
  ...
  { id: '/review',            to: '/review',            label: '复盘',     icon: BookOpenCheck,   group: 'research', extension: false, badge: 'beta' },
  { id: '/indices',           to: '/indices',           label: '指数',     icon: IndicesIcon,       group: 'research', extension: false },
  { id: '/monitor',           to: '/monitor',           label: '监控中心', icon: MonitorIcon,       group: 'system',   extension: false, badge: 'monitor-unread' },
