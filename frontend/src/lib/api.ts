...
export const api = {
  ...
  /** 保存 AI 配置 */
  saveAiSettings: (ai: { provider?: string; base_url?: string; api_key?: string; model?: string; codex_command?: string; codex_reasoning_effort?: string; user_agent?: string; max_tokens?: number }) =>
    request<{ ok: boolean; ai_provider?: string; ai_model?: string; ai_max_tokens?: number; ai_codex_command?: string; ai_codex_reasoning_effort?: string; ai_configured?: boolean }>('/api/settings/ai', {
      method: 'POST',
