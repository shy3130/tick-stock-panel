...
export function Settings() {
  ...
  return (
    <div className="workspace-page">
      ...
      <div className="workspace-content !flex-row gap-4 items-stretch overflow-auto">
        {/* ===== 竖向 Tab 侧栏 ===== */}
          ...
          <div className="sticky top-0 flex flex-col gap-0.5">
            {TABS.map(({ key, label, icon: Icon }) => (
              <button
                ...
                className={cn(
                  'relative flex items-center gap-2 rounded-btn px-3 py-2 text-left text-sm transition-colors duration-150 ease-smooth',
                  activeTab.key === key
