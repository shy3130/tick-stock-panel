...
const MODULES: GuideModule[] = [
  ...
  },
  {
    ...
    workflow: ['先定义假设、样本区间、基准与费用口径', '运行策略、因子、参数网格或策略寻优；网格/寻优场景可一键回填策略表单再验证', '在运行历史中搜索、收藏、打标签，选择 2~4 次结果对比指标、配置差异、交易变化与净值曲线', '查看专业诊断（滚动指标、月度热图、相对基准、持仓期 MAE/MFE）后下载自包含 HTML/JSON/CSV、复跑或打印报告'],
